...
function addListAfterClick(){
	if (todoInputLength() > 0) { //makes sure that an empty input field doesn't create a li
		addTodo();
	}
}

function addListAfterKeypress(event) {
	if (todoInputLength() > 0 && event.which === 13) { //this now looks to see if you hit "enter"/"return"
